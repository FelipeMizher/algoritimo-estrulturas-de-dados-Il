...
class Lista{
    ...
    void inserir(Personagem personagem, int posicao) throws Exception{
        if(posicao < 0 || posicao > p.length){
    ...
    Personagem remover(int posicao) throws Exception{
        if(tamanho == 0 || posicao < 0 || posicao >= tamanho){
            throw new Exception("ERRO AO REMOVER"); 
        }

        Personagem removido = p[posicao];
